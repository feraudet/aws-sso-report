...
for arn in permission_sets:
    resp = esso_admin.describe_permission_set(InstanceArn=instance_arn, PermissionSetArn=arn)
...
for permission_set_arn in permission_sets:
    for account in all_accounts:
        ...
        for page in assign_paginator.paginate(InstanceArn=instance_arn, AccountId=account_id, PermissionSetArn=permission_set_arn):
